...
const READY = [
  ...
  'ورود با موبایل و کتابخانهٔ شخصی (فعلاً با کدِ سندباکس)',
  ...
  'حرکتِ برنامه‌ای روی تصویرِ ثابت — بدونِ هیچ هزینهٔ هوشِ مصنوعی',
];
...
const NOT_READY = [
  ...
  'درگاهِ پیامک — تا آن روز ورود در حالتِ سندباکس است',
];
    ...
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', padding: '60px 22px' }}>
      <div className="wrap" style={{ maxWidth: 760 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, marginTop: 26 }}>
          ...
          <a href="/lab/motion" className="btn btn-ghost">
            آزمایشگاه — ویدیوی بدونِ هزینهٔ AI
          </a>
