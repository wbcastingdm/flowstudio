  ...
  return (
    <>
      ...
      <section id="hero" className="hero">
        <div className="wrap">
          <div className="pill">ارکستراتور تولید ویدیو با هوش مصنوعی</div>
          <h1>از یک ایده تا ویدیوی آمادهٔ انتشار، در یک چرخهٔ کامل</h1>
          <p>
            ایده‌ات را بنویس. سیستم متن را می‌سازد، تصویر تولید می‌کند، با قواعدِ تبلیغاتی بهینه‌اش می‌کند و در
            نهایت به موتورِ ویدیو می‌سپارد — همه در یک پنل، با بهترین ابزارِ هر مرحله.
          </p>
        ...
        <div className="wrap grid-half" style={{ alignItems: 'center' }}>
          <div>
            ...
            <p className="lead" style={{ maxWidth: '52ch', lineHeight: 2 }}>
              همان پروژه، دو تحویلِ متفاوت: نسخهٔ کوتاهِ عمودی برای اینستاگرام و نسخهٔ بلندِ افقی برای نمایشِ
              خانگی و صفحهٔ محصول.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 9 }}>
              ...
              <div className="chip">
                <b>بلند · ۱۶:۹ · تا ۳ دقیقه</b> — پلتفرم خانگی، صفحهٔ محصول، ویترین
              </div>
              <div className="chip">
                <b>انتشارِ مستقیم</b> — از طریقِ ماژولِ وبکستینگ روی سایتِ خودت
              </div>
            </div>
          </div>
