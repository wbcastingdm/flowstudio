 ...
 *
 * چرا «کاربرِ ادمین» ملاک نیست: تا وقتی ورود با `AUTH_PASSWORD`ِ مشترک است،
 * هر کسی با هر شماره‌ای وارد می‌شود، پس نقشِ کاربری هیچ چیزی را قفل نمی‌کند.
 * این راز مستقل از نشست است و روزِ بستنِ آن درِ باز هم معتبر می‌ماند.
 *
