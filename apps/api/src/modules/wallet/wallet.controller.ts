 ...
 * شارژ از پنلِ ادمین.
 *
 * درگاهِ پرداختِ واقعی عمداً اینجا نیست: تا وقتی `OTP_SANDBOX` روشن است هر
 * کسی هر شماره‌ای را تصاحب می‌کند، و پول‌آوردنِ واقعی روی چنین دری یعنی
 * دعوت به سوءاستفاده. اول سندباکس خاموش، بعد درگاه.
 */
